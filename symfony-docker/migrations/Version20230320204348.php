...
final class Version20230320204348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dia ADD evento_id INT DEFAULT NULL, ADD nombre_evento VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dia DROP evento_id, DROP nombre_evento');
    }
}
